...
El algoritmo tiene una complejidad de O(1) 
ya que las dimensiones de la matriz y las 
operaciones dentro de este juego son a lo 
mucho 9, por lo tanto son constantes.
